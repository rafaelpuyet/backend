...
const app = require('../../src/index'); // Ruta de importación corregida
const { PrismaClient } = require('@prisma/client');

const prisma = new PrismaClient();

beforeEach(async () => {
    // Orden de eliminación ajustado para respetar claves foráneas
...
describe('Auth Routes', () => {
    it('should register an individual user successfully', async () => {
        const uniqueEmail = `test-${Date.now()}@example.com`; // Correo único
        const uniqueUsername = `testuser-${Date.now()}`;     // Nombre de usuario único
    ...
    it('should register a business user successfully', async () => {
        const uniqueEmail = `business-${Date.now()}@example.com`; // Correo único
        const uniqueUsername = `businessuser-${Date.now()}`;      // Nombre de usuario único
